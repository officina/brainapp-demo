...
import cc.officina.gatorade.repository.MatchTemplateRepository;
...
public class MatchTemplateResourceIntTest {
    ...
    public void setup() {
        ...
        MatchTemplateResource matchTemplateResource = new MatchTemplateResource(matchTemplateService);
