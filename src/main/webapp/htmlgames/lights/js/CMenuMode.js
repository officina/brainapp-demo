function CMenuMode() {
    ...
    this._init = function () {
        ...
        if (s_aLastLevel[MODE_EASY] < MATRIX_SETTINGS[MODE_EASY].length) {
            _oButPlayMedium.disableButton();
        }
        ...
        if (s_aLastLevel[MODE_MEDIUM] < MATRIX_SETTINGS[MODE_MEDIUM].length) {
            _oButPlayHard.disableButton();
        }
        ...
        if (s_aLastLevel[MODE_EXTREME] < MATRIX_SETTINGS[MODE_EXTREME].length) {
            _oButPlayExtreme.disableButton();
        }
