...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("/api/matches/*/admin/elaborate").hasAuthority(AuthoritiesConstants.ADMIN)
            .antMatchers("/api/matches/*/admin/close").hasAuthority(AuthoritiesConstants.ADMIN)
