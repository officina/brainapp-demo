...
import cc.officina.brainapp.config.audit.AuditEventConverter;
import cc.officina.brainapp.domain.PersistentAuditEvent;
...
import static cc.officina.brainapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
