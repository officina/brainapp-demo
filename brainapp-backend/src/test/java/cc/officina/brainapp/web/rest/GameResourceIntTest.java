...
public class GameResourceIntTest {
    ...
    private static final Boolean DEFAULT_LAST_ATTEMPT_VALID = false;
    private static final Boolean UPDATED_LAST_ATTEMPT_VALID = true;
    ...
    public static Game createEntity(EntityManager em) {
        Game game = new Game()
            ...
            .lastAttemptValid(DEFAULT_LAST_ATTEMPT_VALID);
        return game;
    }
    ...
    public void createGame() throws Exception {
        ...
        assertThat(testGame.isLastAttemptValid()).isEqualTo(DEFAULT_LAST_ATTEMPT_VALID);
    }
    ...
    public void getAllGames() throws Exception {
        ...
        restGameMockMvc.perform(get("/api/games?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].lastAttemptValid").value(hasItem(DEFAULT_LAST_ATTEMPT_VALID.booleanValue())));
    }
    ...
    public void getGame() throws Exception {
        ...
        restGameMockMvc.perform(get("/api/games/{id}", game.getId()))
            ...
            .andExpect(jsonPath("$.lastAttemptValid").value(DEFAULT_LAST_ATTEMPT_VALID.booleanValue()));
    }
    ...
    public void updateGame() throws Exception {
        ...
        updatedGame
            ...
            .lastAttemptValid(UPDATED_LAST_ATTEMPT_VALID);
        ...
        assertThat(testGame.isLastAttemptValid()).isEqualTo(UPDATED_LAST_ATTEMPT_VALID);
    }
