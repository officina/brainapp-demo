  ...
  data: {
    'PRICING': {
      ...
      'RULE_ELECTRIO'         : 'Opposing poles attract each other, it is a universal law.' +
                                ...
                                'But remember the rules: 1. You can connect only opposite charges; ' +
                                '2. Lines must not overlap. You can create the level of your dreams.',
      ...
      'RULE_THIEF_CHALLENGE'  : 'Control this white-collar thief and try to solve the puzzles to complete his crimes! Find out credit card passwords, ' +
                                ...
                                'The challenges become increasingly difficult and you must work against the clock and under pressure.'
    }
  }
};
